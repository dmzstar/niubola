...
libraryDependencies += "org.ocpsoft.rewrite" % "rewrite-integration-faces" % "3.4.2.Final"
//libraryDependencies += "org.ocpsoft.rewrite" % "rewrite-integration-cdi" % "3.4.2.Final"
